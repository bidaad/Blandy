...
import { requestAction, setPageSize, editData, saveData, reduc, checkSecurity, deleteRecord } from './storeBase';
...
export const actionCreators = {
    ...
    editData: (id?: string) => editData<VwMessage>(entityBase.MESSAGE, id, "messagessl"),
