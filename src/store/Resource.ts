...
export const reducer=(state: stateBase<VwResource> | undefined, incomingAction: KnownAction<VwResource>)=>reduc<VwResource>(state,incomingAction, entityBase.RESOURCE)
