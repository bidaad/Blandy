...
import { VwBillOLBKShipStatus, columnStructure } from '../../../model/viewModel/VwBillOLBKShipStatus';
import { Modal } from 'react-bootstrap';
import BillOLBKShipStatusEdit from './BillOLBKShipStatusEdit';
...
type BillOLBKShipStatusProps =
    stateBase<VwBillOLBKShipStatus> &
    typeof BillOLBKShipStatusStore.actionCreators &
    RouteComponentProps<{}> &
{  pId: string,selectRecord: any, editable: boolean, isSelected?: boolean, valuefiltersl: string,noselectId:string,typeForm:string  };


class BillOLBKShipStatus extends React.PureComponent<BillOLBKShipStatusProps, { showModal: boolean }> {
    ...
    componentWillReceiveProps() {
        ...
        const rm:AdminModelRequest={pageNo:pageNo,pageSize:pageSize,filter:filter,resourceName:"BillOLBKShipStatus.Menu",isSelected:isSelected,sort:sort,sortKey:sortKey,parentId:this.props.pId,filtersl:this.props.valuefiltersl,noselectId:this.props.noselectId};
    ...
    editRecord = (id: string) => {
        this.props.ChangeTab('','BillOLBKShipStatus','BillOLBKShipStatusEdit');
            ...
            <React.Fragment>
                ...
                <div key={2}>
                    <Modal size="lg" show={this.state.showModal} onHide={this.handleClose} className={Rtl}>
                        ...
                        <Modal.Body>
                            <BillOLBKShipStatusEdit {...{ closeModal: this.handleClose, refreshGrid: this.refreshGrid, parentId: this.props.parentId }} />
                        </Modal.Body>
