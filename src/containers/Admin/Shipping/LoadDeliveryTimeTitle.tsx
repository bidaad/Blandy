...
import { VwLoadDeliveryTimeTitle, columnStructure } from '../../../model/viewModel/VwLoadDeliveryTimeTitle';
import { Modal } from 'react-bootstrap';
import TTitle from '../../../components/TTitle';
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { faWindowClose } from '@fortawesome/free-solid-svg-icons';
import LoadDeliveryTimeTitleEdit from './LoadDeliveryTimeTitleEdit';
import { Directions } from '../../../model/general';
import { AdminModelRequest } from '../../../model/viewModel/AdminModelRequest';
//var CSSTransitionGroup = require('react-transition-group/CSSTransition')


type LoadDeliveryTimeTitleProps =
    stateBase<VwLoadDeliveryTimeTitle> &
...
class LoadDeliveryTimeTitle extends React.PureComponent<LoadDeliveryTimeTitleProps, { showModal: boolean }> {
    ...
    componentDidMount() {
        ...
        const rm:AdminModelRequest={pageNo:pageNo,pageSize:pageSize,filter:filter,resourceName:"LoadDeliveryTimeTitle.Grid",isSelected:isSelected,sort:sort,sortKey:sortKey,parentId:this.props.pId,filtersl:this.props.valuefiltersl,noselectId:this.props.noselectId};
            ...
            <React.Fragment>
                <div key={1}>
                    ...
                    <ReactGrid
                        {
                        ...{
                            title: 'LoadDeliveryTimeTitle.Grid',
                ...
                <div key={2}>
                    <Modal size="lg" show={this.state.showModal} onHide={this.handleClose} className={Rtl}>
                        ...
                        <Modal.Body>
                            <LoadDeliveryTimeTitleEdit {...{ closeModal: this.handleClose, refreshGrid: this.refreshGrid, parentId: this.props.parentId }} />
                        </Modal.Body>
