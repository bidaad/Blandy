...
import { VwBillOLBooking, columnStructure } from '../../../model/viewModel/VwBillOLBooking';
import { Modal } from 'react-bootstrap';
import BillOLBookingEdit from './BillOLBookingEdit';
...
type BillOLBookingProps =
    stateBase<VwBillOLBooking> &
    typeof BillOLBookingStore.actionCreators &
    RouteComponentProps<{}> &
    {  pId: string,selectRecord: any, editable: boolean, isSelected?: boolean, valuefiltersl: string,noselectId:string,typeForm:string  };


class BillOLBooking extends React.PureComponent<BillOLBookingProps, { showModal: boolean }> {
    ...
    componentWillReceiveProps() {
        ...
        const rm:AdminModelRequest={pageNo:pageNo,pageSize:pageSize,filter:filter,resourceName:"BillOLBooking.Menu",isSelected:isSelected,sort:sort,sortKey:sortKey,parentId:this.props.pId,filtersl:this.props.valuefiltersl,noselectId:this.props.noselectId};
            ...
            <React.Fragment>
                ...
                <div key={2}>
                    <Modal size="lg" show={this.state.showModal} onHide={this.handleClose} className={Rtl}>
                        ...
                        <Modal.Body>
                            <BillOLBookingEdit {...{ closeModal: this.handleClose, refreshGrid: this.refreshGrid, parentId: this.props.parentId }} />
                        </Modal.Body>
