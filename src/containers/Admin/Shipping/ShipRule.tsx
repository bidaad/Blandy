...
import * as ShipRuleStoreSL from '../../../store/ShipRuleSL';
import * as ShipRuleDepStore from '../../../store/ShipRuleDep';
import { VwShipRule, columnStructure } from '../../../model/viewModel/VwShipRule';
...
import ShipRuleEdit, { ShipRuleDepEdit } from './ShipRuleEdit';


type ShipRuleProps =
    stateBase<VwShipRule> &
...
class ShipRule extends React.PureComponent<ShipRuleProps, { showModal: boolean }> {
    ...
    componentDidMount() {
        ...
        const rm:AdminModelRequest={pageNo:pageNo,pageSize:pageSize,filter:filter,resourceName:"ShipRule.Grid",isSelected:isSelected,sort:sort,sortKey:sortKey,parentId:this.props.pId,filtersl:this.props.valuefiltersl,noselectId:this.props.noselectId};
                        ...
                        <Modal.Body>
                            {
                                this.props.typeForm === "dep" ?
                                    <ShipRuleDepEdit {...{ closeModal: this.handleClose, refreshGrid: this.refreshGrid, parentId: this.props.parentId, typeForm: this.props.typeForm }} />
                                    :
                                    <ShipRuleEdit {...{ closeModal: this.handleClose, refreshGrid: this.refreshGrid, parentId: this.props.parentId, typeForm: this.props.typeForm }} />
...
class ShipRuleClass extends ShipRule {
}

export const ShipRuleSelect = connect(
    (state: ApplicationState) => state.shiprulesl,
    ShipRuleStoreSL.actionCreators
)(ShipRuleClass as any);


export const ShipRuleDep = connect(
