...
import { VwFAQ, columnStructure } from '../../../model/viewModel/VwFAQ';
...
class FAQ extends React.PureComponent<FAQProps> {
    ...
    componentDidMount() {
        ...
        const rm:AdminModelRequest={pageNo:pageNo,pageSize:pageSize,filter:filter,resourceName:"FAQ.Menu",isSelected:isSelected,sort:sort,sortKey:sortKey,parentId:this.props.pId,filtersl:this.props.valuefiltersl,noselectId:this.props.noselectId};
    ...
    editRecord = (id: string) => {
        this.props.ChangeTab('','FAQ','FAQEdit');
