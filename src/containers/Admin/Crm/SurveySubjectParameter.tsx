...
import { VwSurveySubjectParameter, columnStructure } from '../../../model/viewModel/VwSurveySubjectParameter';
import { Modal } from 'react-bootstrap';
import SurveySubjectParameterEdit from './SurveySubjectParameterEdit';
...
type SurveySubjectParameterProps =
    stateBase<VwSurveySubjectParameter> &
    typeof SurveySubjectParameterStore.actionCreators &
    RouteComponentProps<{}> &
    {  pId: string,selectRecord: any, editable: boolean, isSelected?: boolean, valuefiltersl: string,noselectId:string,typeForm:string  };


class SurveySubjectParameter extends React.PureComponent<SurveySubjectParameterProps, { showModal: boolean }> {
    ...
    componentDidMount() {
        console.log('SurveySubjectParameter');
    ...
    componentWillReceiveProps() {
        ...
        const rm:AdminModelRequest={pageNo:pageNo,pageSize:pageSize,filter:filter,resourceName:"SurveySubjectParameter.Menu",isSelected:isSelected,sort:sort,sortKey:sortKey,parentId:this.props.pId,filtersl:this.props.valuefiltersl,noselectId:this.props.noselectId};
	...
	//history.push('/SurveySubjectParameterEdit', { id: id });
            ...
            <React.Fragment>
                <div key={1}>
                        <ReactGrid
                            {...
                            {
                                title: 'SurveySubjectParameter.Grid',
                ...
                <div key={2}>
                    <Modal size="lg" show={this.state.showModal} onHide={this.handleClose} className={Rtl}>
                        ...
                        <Modal.Body>
                            <SurveySubjectParameterEdit {...{ closeModal: this.handleClose, refreshGrid: this.refreshGrid, parentId: this.props.parentId }} />
                        </Modal.Body>
