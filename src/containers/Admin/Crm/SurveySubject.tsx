...
import { VwSurveySubject, columnStructure } from '../../../model/viewModel/VwSurveySubject';
import { AdminModelRequest } from '../../../model/viewModel/AdminModelRequest';

type SurveySubjectProps =
    stateBase<VwSurveySubject> &
...
class SurveySubject extends React.PureComponent<SurveySubjectProps> {
    ...
    componentDidMount() {
        ...
        const rm:AdminModelRequest={pageNo:pageNo,pageSize:pageSize,filter:filter,resourceName:"SurveySubject.Menu",isSelected:isSelected,sort:sort,sortKey:sortKey,parentId:this.props.pId,filtersl:this.props.valuefiltersl,noselectId:this.props.noselectId};
    ...
    editRecord = (id: string) => {
        ...
        this.props.ChangeTab('','SurveySubject','SurveySubjectEdit');
