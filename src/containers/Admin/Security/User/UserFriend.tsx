...
import {
  VwUserFriend,
  columnStructure,
} from "../../../../model/viewModel/VwUserFriend";
import { Modal } from "react-bootstrap";
import UserFriendEdit from "./UserFriendEdit";
...
> {
  ...
  editRecord = (id: string) => {
    ...
    //history.push('/UserFriendEdit', { id: id });
