...
import * as HCWeekDayStore from '../../../store/HCWeekDay';
import { AdminModelRequest } from '../../../model/viewModel/AdminModelRequest';
import { VwHCWeekDay, columnStructure } from '../../../model/viewModel/VwHCWeekDay';
 
//var CSSTransitionGroup = require('react-transition-group/CSSTransition')


type HCWeekDayProps =
    stateBase<VwHCWeekDay> &
    typeof HCWeekDayStore.actionCreators &
    RouteComponentProps<{}> &
    {  pId: string,selectRecord: any, editable: boolean, isSelected?: boolean, valuefiltersl: string,noselectId:string,typeForm:string  };

class HCWeekDay extends React.PureComponent<HCWeekDayProps> {
    ...
    componentDidMount() {
        ...
        const rm:AdminModelRequest={pageNo:pageNo,pageSize:pageSize,filter:filter,resourceName:"HCWeekDay.Menu",isSelected:isSelected,sort:sort,sortKey:sortKey,parentId:this.props.pId,filtersl:this.props.valuefiltersl,noselectId:this.props.noselectId};
    ...
    editRecord = (id: string) => {
        this.props.ChangeTab('','HCWeekDay','EditHCWeekDay');
...
export default connect(
    (state: ApplicationState) => state.hcweekday,
    HCWeekDayStore.actionCreators
)(HCWeekDay as any);
