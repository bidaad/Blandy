...
import { VwHCContactType, columnStructure } from '../../../model/viewModel/VwHCContactType';
 
//var CSSTransitionGroup = require('react-transition-group/CSSTransition')


type HCContactTypeProps =
    stateBase<VwHCContactType> &
...
class HCContactType extends React.PureComponent<HCContactTypeProps> {
    ...
    componentDidMount() {
        ...
        const rm:AdminModelRequest={pageNo:pageNo,pageSize:pageSize,filter:filter,resourceName:"HCContactType.Menu",isSelected:isSelected,sort:sort,sortKey:sortKey,parentId:this.props.pId,filtersl:this.props.valuefiltersl,noselectId:this.props.noselectId};
    ...
    editRecord = (id: string) => {
        this.props.ChangeTab('','HCContactType','EditHCContactType');
