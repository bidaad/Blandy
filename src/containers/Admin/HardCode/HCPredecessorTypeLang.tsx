...
import {
  VwHCPredecessorTypeLang,
  columnStructure,
} from "../../../model/viewModel/VwHCPredecessorTypeLang";
import { Modal } from "react-bootstrap";
import HCPredecessorTypeLangEdit from "./HCPredecessorTypeLangEdit";
...
type HCPredecessorTypeLangProps = stateBase<VwHCPredecessorTypeLang> &
  typeof HCPredecessorTypeLangStore.actionCreators &
  RouteComponentProps<{}> & {
    pId: string;
    selectRecord: any;
    editable: boolean;
...
class HCPredecessorTypeLang extends React.PureComponent<
  HCPredecessorTypeLangProps,
  { showModal: boolean }
> {
  ...
  getData = (
    ...
    const rm: AdminModelRequest = {
      ...
      pageSize: pageSize,
      filter: filter,
      resourceName: "HCPredecessorTypeLang.Menu",
  ...
  editRecord = (id: string) => {
    ...
    //history.push('/HCPredecessorTypeLangEdit', { id: id });
    ...
    return (
      <React.Fragment>
        <div key={1}>
          <ReactGrid
            {...{
              title: "HCPredecessorTypeLang.Grid",
        ...
        <div key={2}>
          ...
          >
            <Modal.Header>
              <Modal.Title>
                <TTitle {...{ name: "HCPredecessorTypeLang.EditForm" }} />
              </Modal.Title>
              <FontAwesomeIcon
                icon={faWindowClose}
                color="gray"
