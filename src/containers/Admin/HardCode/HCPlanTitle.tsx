...
import { VwHCPlanTitle, columnStructure } from '../../../model/viewModel/VwHCPlanTitle';
 

type HCPlanTitleProps =
    stateBase<VwHCPlanTitle> &
    typeof HCPlanTitleStore.actionCreators &
    RouteComponentProps<{}> &
     {  pId: string,selectRecord: any, editable: boolean, isSelected?: boolean, valuefiltersl: string,noselectId:string  };

class HCPlanTitle extends React.PureComponent<HCPlanTitleProps> {
    ...
    componentDidMount() {
        ...
        const rm:AdminModelRequest={pageNo:pageNo,pageSize:pageSize,filter:filter,resourceName:"HCPlanTitle.Menu",isSelected:isSelected,sort:sort,sortKey:sortKey,parentId:this.props.pId,filtersl:this.props.valuefiltersl,noselectId:this.props.noselectId};
    ...
    editRecord = (id: string) => {
         ...
         this.props.ChangeTab('','HCPlanTitle','EditHCPlanTitle');
