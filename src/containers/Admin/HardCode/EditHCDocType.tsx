...
type HCDocTypeProps = stateBase<VwHCDocType> &
  typeof HCDocTypeStore.actionCreators &
  RouteComponentProps<{}>;
class EditHCDocType extends React.PureComponent<HCDocTypeProps> {
  ...
  handleSubmit(event: any) {
    ...
    const senddata = convertToObject(sdata) as VwHCDocType;
  ...
  gotoBackPage = () => {
    this.props.ChangeTab("", "EditHCDocType", "HCDocType");
  };
          ...
          <Row>
            <Col md={12} className="T-container">
              <Col md={12} className="T-header">
                <TTitle {...{ name: "HCDocType.EditForm" }} />
              </Col>
              <Form className="edit-form">
                <InputBox
                  {...{
                    name: "HCDocType.EditForm.ID",
                ...
                <Row>
                  ...
                  <Col md={6}>
                    <InputBox
                      {...{
                        name: "HCDocType.EditForm.OrderBy",
                ...
                <Row>
                  <Col md={6}>
                    <InputBox
                      {...{
                        name: "HCDocType.EditForm.Description",
                        type: typeComponent.text,
                  ...
                  <Col md={6}>
                    <InputBox
                      {...{
                        name: "HCDocType.EditForm.IsActive",
                ...
                <Row>
                  <Col md={6}>
                    <TTitle
                      {...{
                        name: "HCDocType.EditForm.Creator",
                        size: 6,
                  ...
                  <Col md={6}>
                    <TTitle
                      {...{
                        name: "HCDocType.EditForm.updator",
                        size: 6,
                ...
                <Row className="mt-2">
                  <Col md={1}>
                    {this.props.saveLoading === true ? (
                      <TButton
                        {...{
                          name: "HCDocType.EditForm.BTN_Save",
                  ...
                  <Col md={1}>
                    <TButton
                      {...{
                        name: "HCDocType.EditForm.BTN_Back",
