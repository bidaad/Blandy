...
import { VwHCResourceTypeLang, columnStructure } from '../../../model/viewModel/VwHCResourceTypeLang';
import { Modal } from 'react-bootstrap';
import HCResourceTypeLangEdit from './EditHCResourceTypeLang';
...
type HCResourceTypeLangProps =
    stateBase<VwHCResourceTypeLang> &
...
class HCResourceTypeLang extends React.PureComponent<HCResourceTypeLangProps, { showModal: boolean }> {
    ...
    componentWillReceiveProps() {
        ...
        const rm:AdminModelRequest={pageNo:pageNo,pageSize:pageSize,filter:filter,resourceName:"HCResourceTypeLang.Menu",isSelected:isSelected,sort:sort,sortKey:sortKey,parentId:this.props.pId,filtersl:this.props.valuefiltersl,noselectId:this.props.noselectId};
	...
	//history.push('/HCResourceTypeLangEdit', { id: id });
...
sort: this.props.sort,
                ...
                <div key={2}>
                    <Modal size="lg" show={this.state.showModal} onHide={this.handleClose} className={Rtl}>
                        ...
                        <Modal.Body>
                            <HCResourceTypeLangEdit {...{ closeModal: this.handleClose, refreshGrid: this.refreshGrid, parentId: this.props.parentId }} />
                        </Modal.Body>
