...
const tabStructure = [
  { key: "hcusertypelang", name: "hcusertypelang" },
] as ComponentColumns[];

type HCUserTypeProps = stateBase<VwHCUserType> &
  typeof HCUserTypeStore.actionCreators &
  RouteComponentProps<{}>;
class EditHCUserType extends React.PureComponent<HCUserTypeProps> {
  ...
  handleSubmit(event: any) {
    ...
    const senddata = convertToObject(sdata) as VwHCUserType;
  ...
  gotoBackPage = () => {
    this.props.ChangeTab("", "EditHCUserType", "HCUserType");
  };
          ...
          <Row>
            <Col md={12} className="T-container">
              <Col md={12} className="T-header">
                <TTitle {...{ name: "HCUserType.EditForm" }} />
              </Col>
              <Form className="edit-form">
                <InputBox
                  {...{
                    name: "HCUserType.EditForm.ID",
                ...
                <Row>
                  ...
                  <Col md={6}>
                    <InputBox
                      {...{
                        name: "HCUserType.EditForm.OrderBy",
                ...
                <Row>
                  <Col md={6}>
                    <InputBox
                      {...{
                        name: "HCUserType.EditForm.Description",
                        type: typeComponent.text,
                  ...
                  <Col md={6}>
                    <InputBox
                      {...{
                        name: "HCUserType.EditForm.IsActive",
                ...
                <Row>
                  <Col md={6}>
                    <TTitle
                      {...{
                        name: "HCUserType.EditForm.Creator",
                        size: 6,
                  ...
                  <Col md={6}>
                    <TTitle
                      {...{
                        name: "HCUserType.EditForm.updator",
                        size: 6,
                ...
                <Row className="mt-2">
                  <Col md={1}>
                    {this.props.saveLoading === true ? (
                      <TButton
                        {...{
                          name: "HCUserType.EditForm.BTN_Save",
                  ...
                  <Col md={1}>
                    <TButton
                      {...{
                        name: "HCUserType.EditForm.BTN_Back",
