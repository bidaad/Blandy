...
import { VwHCJCOperationType, columnStructure } from '../../../model/viewModel/VwHCJCOperationType';
 
//var CSSTransitionGroup = require('react-transition-group/CSSTransition')


type HCJCOperationTypeProps =
    stateBase<VwHCJCOperationType> &
...
class HCJCOperationType extends React.PureComponent<HCJCOperationTypeProps> {
    ...
    componentDidMount() {
        ...
        const rm:AdminModelRequest={pageNo:pageNo,pageSize:pageSize,filter:filter,resourceName:"HCJCOperationType.Menu",isSelected:isSelected,sort:sort,sortKey:sortKey,parentId:this.props.pId,filtersl:this.props.valuefiltersl,noselectId:this.props.noselectId};
    ...
    editRecord = (id: string) => {
        this.props.ChangeTab('','HCJCOperationType','EditHCJCOperationType');
