...
import {
  VwHCPaymentTypeLang,
  columnStructure,
} from "../../../model/viewModel/VwHCPaymentTypeLang";
import { Modal } from "react-bootstrap";
import HCPaymentTypeLangEdit from "./HCPaymentTypeLangEdit";
...
type HCPaymentTypeLangProps = stateBase<VwHCPaymentTypeLang> &
  typeof HCPaymentTypeLangStore.actionCreators &
  RouteComponentProps<{}> & {
    pId: string;
    selectRecord: any;
    editable: boolean;
...
class HCPaymentTypeLang extends React.PureComponent<
  HCPaymentTypeLangProps,
  { showModal: boolean }
> {
  ...
  getData = (
    ...
    const rm: AdminModelRequest = {
      ...
      pageSize: pageSize,
      filter: filter,
      resourceName: "HCPaymentTypeLang.Menu",
  ...
  editRecord = (id: string) => {
    ...
    //history.push('/HCPaymentTypeLangEdit', { id: id });
      ...
      <React.Fragment>
        ...
        <div key={2}>
          ...
          >
            <Modal.Header>
              <Modal.Title>
                <TTitle {...{ name: "HCPaymentTypeLang.EditForm" }} />
              </Modal.Title>
              <FontAwesomeIcon
                icon={faWindowClose}
                color="gray"
