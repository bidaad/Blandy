...
import { VwHCUnit, columnStructure } from '../../../model/viewModel/VwHCUnit';
...
class HCUnit extends React.PureComponent<HCUnitProps> {
    ...
    componentDidMount() {
        ...
        const rm:AdminModelRequest={pageNo:pageNo,pageSize:pageSize,filter:filter,resourceName:"HCUnit.Menu",isSelected:isSelected,sort:sort,sortKey:sortKey,parentId:this.props.pId,filtersl:this.props.valuefiltersl,noselectId:this.props.noselectId};
    ...
    editRecord = (id: string) => {
        this.props.ChangeTab('','HCUnit','EditHCUnit');
