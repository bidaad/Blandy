...
import { VwHCPlanType, columnStructure } from '../../../model/viewModel/VwHCPlanType';
 

type HCPlanTypeProps =
    stateBase<VwHCPlanType> &
    typeof HCPlanTypeStore.actionCreators &
    RouteComponentProps<{}> &
     {  pId: string,selectRecord: any, editable: boolean, isSelected?: boolean, valuefiltersl: string,noselectId:string  };

class HCPlanType extends React.PureComponent<HCPlanTypeProps> {
    ...
    componentDidMount() {
        ...
        const rm:AdminModelRequest={pageNo:pageNo,pageSize:pageSize,filter:filter,resourceName:"HCPlanType.Menu",isSelected:isSelected,sort:sort,sortKey:sortKey,parentId:this.props.pId,filtersl:this.props.valuefiltersl,noselectId:this.props.noselectId};
    ...
    editRecord = (id: string) => {
         ...
         this.props.ChangeTab('','HCPlanType','HCPlanTypeEdit');
