...
import { VwHCActionTypeLang, columnStructure } from '../../../model/viewModel/VwHCActionTypeLang';
import { Modal } from 'react-bootstrap';
import HCActionTypeLangEdit from './EditHCActionTypeLang';
...
type HCActionTypeLangProps =
    stateBase<VwHCActionTypeLang> &
...
class HCActionTypeLang extends React.PureComponent<HCActionTypeLangProps, { showModal: boolean }> {
    ...
    componentWillReceiveProps() {
        ...
        const rm:AdminModelRequest={pageNo:pageNo,pageSize:pageSize,filter:filter,resourceName:"HCActionTypeLang.Menu",isSelected:isSelected,sort:sort,sortKey:sortKey,parentId:this.props.pId,filtersl:this.props.valuefiltersl,noselectId:this.props.noselectId};
	...
	//history.push('/HCActionTypeLangEdit', { id: id });
...
sort: this.props.sort,
                ...
                <div key={2}>
                    <Modal size="lg" show={this.state.showModal} onHide={this.handleClose} className={Rtl}>
                        ...
                        <Modal.Body>
                            <HCActionTypeLangEdit {...{ closeModal: this.handleClose, refreshGrid: this.refreshGrid, parentId: this.props.parentId }} />
                        </Modal.Body>
