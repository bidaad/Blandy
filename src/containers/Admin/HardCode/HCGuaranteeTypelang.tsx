...
import {
  VwHCGuaranteeTypelang,
  columnStructure,
} from "../../../model/viewModel/VwHCGuaranteeTypelang";
import { Modal } from "react-bootstrap";
import HCGuaranteeTypelangEdit from "./HCGuaranteeTypelangEdit";
...
type HCGuaranteeTypelangProps = stateBase<VwHCGuaranteeTypelang> &
  typeof HCGuaranteeTypelangStore.actionCreators &
  RouteComponentProps<{}> & {
    pId: string;
    selectRecord: any;
    editable: boolean;
...
class HCGuaranteeTypelang extends React.PureComponent<
  HCGuaranteeTypelangProps,
  { showModal: boolean }
> {
  ...
  getData = (
    ...
    const rm: AdminModelRequest = {
      ...
      pageSize: pageSize,
      filter: filter,
      resourceName: "HCGuaranteeTypelang.Menu",
  ...
  editRecord = (id: string) => {
    ...
    //history.push('/HCGuaranteeTypelangEdit', { id: id });
    ...
    return (
      <React.Fragment>
        <div key={1}>
          <ReactGrid
            {...{
              title: "HCGuaranteeTypelang.Grid",
        ...
        <div key={2}>
          ...
          >
            <Modal.Header>
              <Modal.Title>
                <TTitle {...{ name: "HCGuaranteeTypelang.EditForm" }} />
              </Modal.Title>
              <FontAwesomeIcon
                icon={faWindowClose}
                color="gray"
