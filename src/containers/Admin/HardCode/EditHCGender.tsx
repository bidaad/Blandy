...
const tabStructure = [
  { key: "hcgenderlang", name: "hcgenderlang" },
] as ComponentColumns[];

type HCGenderProps = stateBase<VwHCGender> &
  typeof HCGenderStore.actionCreators &
  RouteComponentProps<{}>;
class EditHCGender extends React.PureComponent<HCGenderProps> {
  ...
  handleSubmit(event: any) {
    ...
    const senddata = convertToObject(sdata) as VwHCGender;
  ...
  gotoBackPage = () => {
    this.props.ChangeTab("", "EditHCGender", "HCGender");
  };
          ...
          <Row>
            <Col md={12} className="T-container">
              <Col md={12} className="T-header">
                <TTitle {...{ name: "HCGender.EditForm" }} />
              </Col>
              <Form className="edit-form">
                <InputBox
                  {...{
                    name: "HCGender.EditForm.ID",
                ...
                <Row>
                  ...
                  <Col md={6}>
                    <InputBox
                      {...{
                        name: "HCGender.EditForm.OrderBy",
                ...
                <Row>
                  <Col md={6}>
                    <InputBox
                      {...{
                        name: "HCGender.EditForm.Description",
                        type: typeComponent.text,
                  ...
                  <Col md={6}>
                    <InputBox
                      {...{
                        name: "HCGender.EditForm.IsActive",
                ...
                <Row>
                  <Col md={6}>
                    <TTitle
                      {...{
                        name: "HCGender.EditForm.Creator",
                        size: 6,
                  ...
                  <Col md={6}>
                    <TTitle
                      {...{
                        name: "HCGender.EditForm.updator",
                        size: 6,
                ...
                <Row className="mt-2">
                  <Col md={1}>
                    {this.props.saveLoading === true ? (
                      <TButton
                        {...{
                          name: "HCGender.EditForm.BTN_Save",
                  ...
                  <Col md={1}>
                    <TButton
                      {...{
                        name: "HCGender.EditForm.BTN_Back",
