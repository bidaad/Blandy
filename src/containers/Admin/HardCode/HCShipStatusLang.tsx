...
import {
  VwHCShipStatusLang,
  columnStructure,
} from "../../../model/viewModel/VwHCShipStatusLang";
import { Modal } from "react-bootstrap";
import HCShipStatusLangEdit from "./HCShipStatusLangEdit";
...
type HCShipStatusLangProps = stateBase<VwHCShipStatusLang> &
  typeof HCShipStatusLangStore.actionCreators &
  RouteComponentProps<{}> & {
    pId: string;
    selectRecord: any;
    editable: boolean;
...
class HCShipStatusLang extends React.PureComponent<
  HCShipStatusLangProps,
  { showModal: boolean }
> {
  ...
  getData = (
    ...
    const rm: AdminModelRequest = {
      ...
      pageSize: pageSize,
      filter: filter,
      resourceName: "HCShipStatusLang.Menu",
  ...
  editRecord = (id: string) => {
    ...
    //history.push('/HCShipStatusLangEdit', { id: id });
      ...
      <React.Fragment>
        ...
        <div key={2}>
          ...
          >
            <Modal.Header>
              <Modal.Title>
                <TTitle {...{ name: "HCShipStatusLang.EditForm" }} />
              </Modal.Title>
              <FontAwesomeIcon
                icon={faWindowClose}
                color="gray"
