...
import { VwHCPaymentType, columnStructure } from '../../../model/viewModel/VwHCPaymentType';
 
//var CSSTransitionGroup = require('react-transition-group/CSSTransition')


type HCPaymentTypeProps =
    stateBase<VwHCPaymentType> &
...
class HCPaymentType extends React.PureComponent<HCPaymentTypeProps> {
    ...
    componentDidMount() {
        ...
        const rm:AdminModelRequest={pageNo:pageNo,pageSize:pageSize,filter:filter,resourceName:"HCPaymentType.Menu",isSelected:isSelected,sort:sort,sortKey:sortKey,parentId:this.props.pId,filtersl:this.props.valuefiltersl,noselectId:this.props.noselectId};
    ...
    editRecord = (id: string) => {
        this.props.ChangeTab('','HCPaymentType','EditHCPaymentType');
