...
import {
  VwHCPlanTypeLang,
  columnStructure,
} from "../../../model/viewModel/VwHCPlanTypeLang";
import { Modal } from "react-bootstrap";
import HCPlanTypeLangEdit from "./HCPlanTypeLangEdit";
...
type HCPlanTypeLangProps = stateBase<VwHCPlanTypeLang> &
  typeof HCPlanTypeLangStore.actionCreators &
  RouteComponentProps<{}> & {
    pId: string;
    selectRecord: any;
    editable: boolean;
...
class HCPlanTypeLang extends React.PureComponent<
  HCPlanTypeLangProps,
  { showModal: boolean }
> {
  ...
  getData = (
    ...
    const rm: AdminModelRequest = {
      ...
      pageSize: pageSize,
      filter: filter,
      resourceName: "HCPlanTypeLang.Menu",
  ...
  editRecord = (id: string) => {
    ...
    //history.push('/HCPlanTypeLangEdit', { id: id });
      ...
      <React.Fragment>
        ...
        <div key={2}>
          ...
          >
            <Modal.Header>
              <Modal.Title>
                <TTitle {...{ name: "HCPlanTypeLang.EditForm" }} />
              </Modal.Title>
              <FontAwesomeIcon
                icon={faWindowClose}
                color="gray"
