...
import { VwHCMonth, columnStructure } from '../../../model/viewModel/VwHCMonth';
 

type HCMonthProps =
    stateBase<VwHCMonth> &
    typeof HCMonthStore.actionCreators &
    RouteComponentProps<{}> &
     {  pId: string,selectRecord: any, editable: boolean, isSelected?: boolean, valuefiltersl: string,noselectId:string  };

class HCMonth extends React.PureComponent<HCMonthProps> {
    ...
    componentDidMount() {
        ...
        const rm:AdminModelRequest={pageNo:pageNo,pageSize:pageSize,filter:filter,resourceName:"HCMonth.Menu",isSelected:isSelected,sort:sort,sortKey:sortKey,parentId:this.props.pId,filtersl:this.props.valuefiltersl,noselectId:this.props.noselectId};
    ...
    editRecord = (id: string) => {
        this.props.ChangeTab('','HCMonth','EditHCMonth');
