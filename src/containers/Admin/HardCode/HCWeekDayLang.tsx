...
import {
  VwHCWeekDayLang,
  columnStructure,
} from "../../../model/viewModel/VwHCWeekDayLang";
import { Modal } from "react-bootstrap";
import HCWeekDayLangEdit from "./HCWeekDayLangEdit";
...
type HCWeekDayLangProps = stateBase<VwHCWeekDayLang> &
  typeof HCWeekDayLangStore.actionCreators &
  RouteComponentProps<{}> & {
    pId: string;
    selectRecord: any;
    editable: boolean;
...
class HCWeekDayLang extends React.PureComponent<
  HCWeekDayLangProps,
  { showModal: boolean }
> {
  ...
  getData = (
    ...
    const rm: AdminModelRequest = {
      ...
      pageSize: pageSize,
      filter: filter,
      resourceName: "HCWeekDayLang.Menu",
  ...
  editRecord = (id: string) => {
    ...
    //history.push('/HCWeekDayLangEdit', { id: id });
      ...
      <React.Fragment>
        ...
        <div key={2}>
          ...
          >
            <Modal.Header>
              <Modal.Title>
                <TTitle {...{ name: "HCWeekDayLang.EditForm" }} />
              </Modal.Title>
              <FontAwesomeIcon
                icon={faWindowClose}
                color="gray"
