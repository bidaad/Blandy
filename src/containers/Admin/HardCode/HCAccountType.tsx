...
import { VwHCAccountType, columnStructure } from '../../../model/viewModel/VwHCAccountType';
 
//var CSSTransitionGroup = require('react-transition-group/CSSTransition')



type HCAccountTypeProps =
    stateBase<VwHCAccountType> &
...
class HCAccountType extends React.PureComponent<HCAccountTypeProps> {
    ...
    componentDidMount() {
        ...
        const rm:AdminModelRequest={pageNo:pageNo,pageSize:pageSize,filter:filter,resourceName:"HCAccountType.Menu",isSelected:isSelected,sort:sort,sortKey:sortKey,parentId:this.props.pId,filtersl:this.props.valuefiltersl,noselectId:this.props.noselectId};
    ...
    editRecord = (id: string) => {
        this.props.ChangeTab('','HCAccountType','EditHCAccountType');
