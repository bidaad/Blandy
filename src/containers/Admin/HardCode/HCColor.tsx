...
import { VwHCColor, columnStructure } from '../../../model/viewModel/VwHCColor';
...
class HCColor extends React.PureComponent<HCColorProps> {
    ...
    getData = (pageNo: number, pageSize: number, filter: string, sort?: string, sortKey?: string) => {
        ...
        const rm: AdminModelRequest = { pageNo: pageNo, pageSize: pageSize, filter: filter, resourceName: "HCColor.Menu", isSelected: isSelected, sort: sort, sortKey: sortKey, parentId: this.props.pId, filtersl: this.props.valuefiltersl, noselectId: this.props.noselectId };
    ...
    editRecord = (id: string) => {
        ...
        this.props.ChangeTab('', 'HCColor', 'EditHCColor');
