...
import { VwHCWHOperationStatusLang, columnStructure } from '../../../model/viewModel/VwHCWHOperationStatusLang';
import { Modal } from 'react-bootstrap';
import HCWHOperationStatusLangEdit from './EditHCWHOperationStatusLang';
...
type HCWHOperationStatusLangProps =
    stateBase<VwHCWHOperationStatusLang> &
...
class HCWHOperationStatusLang extends React.PureComponent<HCWHOperationStatusLangProps, { showModal: boolean }> {
    ...
    componentWillReceiveProps() {
        ...
        const rm:AdminModelRequest={pageNo:pageNo,pageSize:pageSize,filter:filter,resourceName:"HCWHOperationStatusLang.Menu",isSelected:isSelected,sort:sort,sortKey:sortKey,parentId:this.props.pId,filtersl:this.props.valuefiltersl,noselectId:this.props.noselectId};
	...
	//history.push('/HCWHOperationStatusLangEdit', { id: id });
            ...
            <React.Fragment>
                <div key={1}>
                        <ReactGrid
                            {...
                            {
                                title: 'HCWHOperationStatusLang.Grid',
...
sort: this.props.sort,
                ...
                <div key={2}>
                    <Modal size="lg" show={this.state.showModal} onHide={this.handleClose} className={Rtl}>
                        ...
                        <Modal.Body>
                            <HCWHOperationStatusLangEdit {...{ closeModal: this.handleClose, refreshGrid: this.refreshGrid, parentId: this.props.parentId }} />
                        </Modal.Body>
...
)(HCWHOperationStatusLang as any);
