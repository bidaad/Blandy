...
import {
  VwHCHardConditionLang,
  columnStructure,
} from "../../../model/viewModel/VwHCHardConditionLang";
import { Modal } from "react-bootstrap";
import HCHardConditionLangEdit from "./HCHardConditionLangEdit";
...
type HCHardConditionLangProps = stateBase<VwHCHardConditionLang> &
  typeof HCHardConditionLangStore.actionCreators &
  RouteComponentProps<{}> & {
    pId: string;
    selectRecord: any;
    editable: boolean;
...
class HCHardConditionLang extends React.PureComponent<
  HCHardConditionLangProps,
  { showModal: boolean }
> {
  ...
  getData = (
    ...
    const rm: AdminModelRequest = {
      ...
      pageSize: pageSize,
      filter: filter,
      resourceName: "HCHardConditionLang.Menu",
  ...
  editRecord = (id: string) => {
    ...
    //history.push('/HCHardConditionLangEdit', { id: id });
    ...
    return (
      <React.Fragment>
        <div key={1}>
          <ReactGrid
            {...{
              title: "HCHardConditionLang.Grid",
        ...
        <div key={2}>
          ...
          >
            <Modal.Header>
              <Modal.Title>
                <TTitle {...{ name: "HCHardConditionLang.EditForm" }} />
              </Modal.Title>
              <FontAwesomeIcon
                icon={faWindowClose}
                color="gray"
