...
import { VwHCPaymentStatus, columnStructure } from '../../../model/viewModel/VwHCPaymentStatus';

//var CSSTransitionGroup = require('react-transition-group/CSSTransition')


type HCPaymentStatusProps =
    stateBase<VwHCPaymentStatus> &
...
class HCPaymentStatus extends React.PureComponent<HCPaymentStatusProps> {
    ...
    getData = (pageNo: number, pageSize: number, filter: string, sort?: string, sortKey?: string) => {
        ...
        const rm: AdminModelRequest = { pageNo: pageNo, pageSize: pageSize, filter: filter, resourceName: "HCPaymentStatus.Menu", isSelected: isSelected, sort: sort, sortKey: sortKey, parentId: this.props.pId, filtersl: this.props.valuefiltersl, noselectId: this.props.noselectId };
    ...
    editRecord = (id: string) => {
        this.props.ChangeTab('', 'HCPaymentStatus', 'EditHCPaymentStatus');
