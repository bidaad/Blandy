...
import { VwHCChatStatus, columnStructure } from '../../../model/viewModel/VwHCChatStatus';
 

type HCChatStatusProps =
    stateBase<VwHCChatStatus> &
...
class HCChatStatus extends React.PureComponent<HCChatStatusProps> {
    ...
    componentDidMount() {
        ...
        const rm:AdminModelRequest={pageNo:pageNo,pageSize:pageSize,filter:filter,resourceName:"HCChatStatus.Menu",isSelected:isSelected,sort:sort,sortKey:sortKey,parentId:this.props.pId,filtersl:this.props.valuefiltersl,noselectId:this.props.noselectId};
    ...
    editRecord = (id: string) => {
        this.props.ChangeTab('','HCChatStatus','EditHCChatStatus');
