...
import { VwHCHardCondition, columnStructure } from '../../../model/viewModel/VwHCHardCondition';
 

type HCHardConditionProps =
    stateBase<VwHCHardCondition> &
    typeof HCHardConditionStore.actionCreators &
    RouteComponentProps<{}> &
     {  pId: string,selectRecord: any, editable: boolean, isSelected?: boolean, valuefiltersl: string,noselectId:string  };

class HCHardCondition extends React.PureComponent<HCHardConditionProps> {
    ...
    componentDidMount() {
        ...
        const rm:AdminModelRequest={pageNo:pageNo,pageSize:pageSize,filter:filter,resourceName:"HCHardCondition.Menu",isSelected:isSelected,sort:sort,sortKey:sortKey,parentId:this.props.pId,filtersl:this.props.valuefiltersl,noselectId:this.props.noselectId};
    ...
    editRecord = (id: string) => {
        this.props.ChangeTab('','HCHardCondition','HCHardConditionEdit');
