...
import {
  VwHCAssetQualityLang,
  columnStructure,
} from "../../../model/viewModel/VwHCAssetQualityLang";
import { Modal } from "react-bootstrap";
import HCAssetQualityLangEdit from "./EditHCAssetQualityLang";
...
class HCAssetQualityLang extends React.PureComponent<
  HCAssetQualityLangProps,
  { showModal: boolean }
> {
  ...
  getData = (
    ...
    const rm: AdminModelRequest = {
      ...
      pageSize: pageSize,
      filter: filter,
      resourceName: "HCAssetQualityLang.Menu",
  ...
  editRecord = (id: string) => {
    ...
    //history.push('/HCAssetQualityLangEdit', { id: id });
