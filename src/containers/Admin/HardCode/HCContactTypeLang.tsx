...
import { VwHCContactTypeLang, columnStructure } from '../../../model/viewModel/VwHCContactTypeLang';
import { Modal } from 'react-bootstrap';
import HCContactTypeLangEdit from './EditHCContactTypeLang';
...
type HCContactTypeLangProps =
    stateBase<VwHCContactTypeLang> &
...
class HCContactTypeLang extends React.PureComponent<HCContactTypeLangProps, { showModal: boolean }> {
    ...
    componentWillReceiveProps() {
        ...
        const rm:AdminModelRequest={pageNo:pageNo,pageSize:pageSize,filter:filter,resourceName:"HCContactTypeLang.Menu",isSelected:isSelected,sort:sort,sortKey:sortKey,parentId:this.props.pId,filtersl:this.props.valuefiltersl,noselectId:this.props.noselectId};
	...
	//history.push('/HCContactTypeLangEdit', { id: id });
...
sort: this.props.sort,
                ...
                <div key={2}>
                    <Modal size="lg" show={this.state.showModal} onHide={this.handleClose} className={Rtl}>
                        ...
                        <Modal.Body>
                            <HCContactTypeLangEdit {...{ closeModal: this.handleClose, refreshGrid: this.refreshGrid, parentId: this.props.parentId }} />
                        </Modal.Body>
