...
import {
  VwHCPaymentStatusLang,
  columnStructure,
} from "../../../model/viewModel/VwHCPaymentStatusLang";
import { Modal } from "react-bootstrap";
import HCPaymentStatusLangEdit from "./HCPaymentStatusLangEdit";
...
type HCPaymentStatusLangProps = stateBase<VwHCPaymentStatusLang> &
  typeof HCPaymentStatusLangStore.actionCreators &
  RouteComponentProps<{}> & {
    pId: string;
    selectRecord: any;
    editable: boolean;
...
class HCPaymentStatusLang extends React.PureComponent<
  HCPaymentStatusLangProps,
  { showModal: boolean }
> {
  ...
  getData = (
    ...
    const rm: AdminModelRequest = {
      ...
      pageSize: pageSize,
      filter: filter,
      resourceName: "HCPaymentStatusLang.Menu",
  ...
  editRecord = (id: string) => {
    ...
    //history.push('/HCPaymentStatusLangEdit', { id: id });
    ...
    return (
      <React.Fragment>
        <div key={1}>
          <ReactGrid
            {...{
              title: "HCPaymentStatusLang.Grid",
        ...
        <div key={2}>
          ...
          >
            <Modal.Header>
              <Modal.Title>
                <TTitle {...{ name: "HCPaymentStatusLang.EditForm" }} />
              </Modal.Title>
              <FontAwesomeIcon
                icon={faWindowClose}
                color="gray"
