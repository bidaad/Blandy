...
import { VwHCAttributeTitleLang, columnStructure } from '../../../model/viewModel/VwHCAttributeTitleLang';
import { Modal } from 'react-bootstrap';
import HCAttributeTitleLangEdit from './EditHCAttributeTitleLang';
...
type HCAttributeTitleLangProps =
    stateBase<VwHCAttributeTitleLang> &
...
class HCAttributeTitleLang extends React.PureComponent<HCAttributeTitleLangProps, { showModal: boolean }> {
    ...
    componentWillReceiveProps() {
        ...
        const rm:AdminModelRequest={pageNo:pageNo,pageSize:pageSize,filter:filter,resourceName:"HCAttributeTitleLang.Menu",isSelected:isSelected,sort:sort,sortKey:sortKey,parentId:this.props.pId,filtersl:this.props.valuefiltersl,noselectId:this.props.noselectId};
	...
	//history.push('/HCAttributeTitleLangEdit', { id: id });
            ...
            <React.Fragment>
                <div key={1}>
                        <ReactGrid
                            {...
                            {
                                title: 'HCAttributeTitleLang.Grid',
...
sort: this.props.sort,
                ...
                <div key={2}>
                    <Modal size="lg" show={this.state.showModal} onHide={this.handleClose} className={Rtl}>
                        ...
                        <Modal.Body>
                            <HCAttributeTitleLangEdit {...{ closeModal: this.handleClose, refreshGrid: this.refreshGrid, parentId: this.props.parentId }} />
                        </Modal.Body>
