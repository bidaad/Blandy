...
import { VwHCUnitLang, columnStructure } from '../../../model/viewModel/VwHCUnitLang';
import { Modal } from 'react-bootstrap';
import HCUnitLangEdit from './EditHCUnitLang';
...
type HCUnitLangProps =
    stateBase<VwHCUnitLang> &
...
class HCUnitLang extends React.PureComponent<HCUnitLangProps, { showModal: boolean }> {
    ...
    componentWillReceiveProps() {
        ...
        const rm:AdminModelRequest={pageNo:pageNo,pageSize:pageSize,filter:filter,resourceName:"HCUnitLang.Menu",isSelected:isSelected,sort:sort,sortKey:sortKey,parentId:this.props.pId,filtersl:this.props.valuefiltersl,noselectId:this.props.noselectId};
	...
	//history.push('/HCUnitLangEdit', { id: id });
...
sort: this.props.sort,
                ...
                <div key={2}>
                    <Modal size="lg" show={this.state.showModal} onHide={this.handleClose} className={Rtl}>
                        ...
                        <Modal.Body>
                            <HCUnitLangEdit {...{ closeModal: this.handleClose, refreshGrid: this.refreshGrid, parentId: this.props.parentId }} />
                        </Modal.Body>
