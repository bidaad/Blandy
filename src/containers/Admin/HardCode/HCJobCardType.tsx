...
import { VwHCJobCardType, columnStructure } from '../../../model/viewModel/VwHCJobCardType';
 
//var CSSTransitionGroup = require('react-transition-group/CSSTransition')


type HCJobCardTypeProps =
    stateBase<VwHCJobCardType> &
...
class HCJobCardType extends React.PureComponent<HCJobCardTypeProps> {
    ...
    componentDidMount() {
        ...
        const rm:AdminModelRequest={pageNo:pageNo,pageSize:pageSize,filter:filter,resourceName:"HCJobCardType.Menu",isSelected:isSelected,sort:sort,sortKey:sortKey,parentId:this.props.pId,filtersl:this.props.valuefiltersl,noselectId:this.props.noselectId};
    ...
    editRecord = (id: string) => {
        this.props.ChangeTab('','HCJobCardType','EditHCJobCardType');
