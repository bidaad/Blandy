...
import { VwHCZoneTypeLang, columnStructure } from '../../../model/viewModel/VwHCZoneTypeLang';
import { Modal } from 'react-bootstrap';
import HCZoneTypeLangEdit from './EditHCZoneTypeLang';
...
type HCZoneTypeLangProps =
    stateBase<VwHCZoneTypeLang> &
...
class HCZoneTypeLang extends React.PureComponent<HCZoneTypeLangProps, { showModal: boolean }> {
    ...
    componentWillReceiveProps() {
        ...
        const rm:AdminModelRequest={pageNo:pageNo,pageSize:pageSize,filter:filter,resourceName:"HCZoneTypeLang.Menu",isSelected:isSelected,sort:sort,sortKey:sortKey,parentId:this.props.pId,filtersl:this.props.valuefiltersl,noselectId:this.props.noselectId};
	...
	//history.push('/HCZoneTypeLangEdit', { id: id });
...
sort: this.props.sort,
                ...
                <div key={2}>
                    <Modal size="lg" show={this.state.showModal} onHide={this.handleClose} className={Rtl}>
                        ...
                        <Modal.Body>
                            <HCZoneTypeLangEdit {...{ closeModal: this.handleClose, refreshGrid: this.refreshGrid, parentId: this.props.parentId }} />
                        </Modal.Body>
