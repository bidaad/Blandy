...
import {
  VwHCColorLang,
  columnStructure,
} from "../../../model/viewModel/VwHCColorLang";
import { Modal } from "react-bootstrap";
import HCColorLangEdit from "./HCColorLangEdit";
...
type HCColorLangProps = stateBase<VwHCColorLang> &
  typeof HCColorLangStore.actionCreators &
  RouteComponentProps<{}> & {
    pId: string;
    selectRecord: any;
    editable: boolean;
...
class HCColorLang extends React.PureComponent<
  HCColorLangProps,
  { showModal: boolean }
> {
  ...
  editRecord = (id: string) => {
    ...
    //history.push('/HCColorLangEdit', { id: id });
