...
import { VwHCPlanTitleLang, columnStructure } from '../../../model/viewModel/VwHCPlanTitleLang';
import { Modal } from 'react-bootstrap';
import HCPlanTitleLangEdit from './HCPlanTitleLangEdit';
...
type HCPlanTitleLangProps =
    stateBase<VwHCPlanTitleLang> &
    typeof HCPlanTitleLangStore.actionCreators &
    RouteComponentProps<{}> &
    {  pId: string,selectRecord: any, editable: boolean, isSelected?: boolean, valuefiltersl: string,noselectId:string,typeForm:string  };


class HCPlanTitleLang extends React.PureComponent<HCPlanTitleLangProps, { showModal: boolean }> {
    ...
    componentWillReceiveProps() {
        ...
        const rm:AdminModelRequest={pageNo:pageNo,pageSize:pageSize,filter:filter,resourceName:"HCPlanTitleLang.Menu",isSelected:isSelected,sort:sort,sortKey:sortKey,parentId:this.props.pId,filtersl:this.props.valuefiltersl,noselectId:this.props.noselectId};
	...
	//history.push('/HCPlanTitleLangEdit', { id: id });
            ...
            <React.Fragment>
                ...
                <div key={2}>
                    <Modal size="lg" show={this.state.showModal} onHide={this.handleClose} className={Rtl}>
                        ...
                        <Modal.Body>
                            <HCPlanTitleLangEdit {...{ closeModal: this.handleClose, refreshGrid: this.refreshGrid, parentId: this.props.parentId }} />
                        </Modal.Body>
