...
import { VwHCAssetHealthStatus, columnStructure } from '../../../model/viewModel/VwHCAssetHealthStatus';
 
//var CSSTransitionGroup = require('react-transition-group/CSSTransition')


type HCAssetHealthStatusProps =
    stateBase<VwHCAssetHealthStatus> &
...
class HCAssetHealthStatus extends React.PureComponent<HCAssetHealthStatusProps> {
    ...
    componentDidMount() {
        ...
        const rm:AdminModelRequest={pageNo:pageNo,pageSize:pageSize,filter:filter,resourceName:"HCAssetHealthStatus.Menu",isSelected:isSelected,sort:sort,sortKey:sortKey,parentId:this.props.pId,filtersl:this.props.valuefiltersl,noselectId:this.props.noselectId};
    ...
    editRecord = (id: string) => {
        this.props.ChangeTab('','HCAssetHealthStatus','EditHCAssetHealthStatus');
   ...
   {
   ...{
       title: 'HCAssetHealthStatus.Grid',
