...
import { VwHCWHOperationTypeLang, columnStructure } from '../../../model/viewModel/VwHCWHOperationTypeLang';
import { Modal } from 'react-bootstrap';
import HCWHOperationTypeLangEdit from './EditHCWHOperationTypeLang';
...
type HCWHOperationTypeLangProps =
    stateBase<VwHCWHOperationTypeLang> &
    typeof HCWHOperationTypeLangStore.actionCreators &
    RouteComponentProps<{}> &
    {  pId: string,selectRecord: any, editable: boolean, isSelected?: boolean, valuefiltersl: string,noselectId:string,typeForm:string  };


class HCWHOperationTypeLang extends React.PureComponent<HCWHOperationTypeLangProps, { showModal: boolean }> {
    ...
    componentWillReceiveProps() {
        ...
        const rm:AdminModelRequest={pageNo:pageNo,pageSize:pageSize,filter:filter,resourceName:"HCWHOperationTypeLang.Menu",isSelected:isSelected,sort:sort,sortKey:sortKey,parentId:this.props.pId,filtersl:this.props.valuefiltersl,noselectId:this.props.noselectId};
	...
	//history.push('/HCWHOperationTypeLangEdit', { id: id });
            ...
            <React.Fragment>
                <div key={1}>
                        <ReactGrid
                            {...
                            {
                                title: 'HCWHOperationTypeLang.Grid',
...
sort: this.props.sort,
                ...
                <div key={2}>
                    <Modal size="lg" show={this.state.showModal} onHide={this.handleClose} className={Rtl}>
                        ...
                        <Modal.Body>
                            <HCWHOperationTypeLangEdit {...{ closeModal: this.handleClose, refreshGrid: this.refreshGrid, parentId: this.props.parentId }} />
                        </Modal.Body>
