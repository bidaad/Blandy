...
import {
  VwHCPriorityLang,
  columnStructure,
} from "../../../model/viewModel/VwHCPriorityLang";
import { Modal } from "react-bootstrap";
import HCPriorityLangEdit from "./HCPriorityLangEdit";
...
type HCPriorityLangProps = stateBase<VwHCPriorityLang> &
  typeof HCPriorityLangStore.actionCreators &
  RouteComponentProps<{}> & {
    pId: string;
    selectRecord: any;
    editable: boolean;
...
class HCPriorityLang extends React.PureComponent<
  HCPriorityLangProps,
  { showModal: boolean }
> {
  ...
  getData = (
    ...
    const rm: AdminModelRequest = {
      ...
      pageSize: pageSize,
      filter: filter,
      resourceName: "HCPriorityLang.Menu",
  ...
  editRecord = (id: string) => {
    ...
    //history.push('/HCPriorityLangEdit', { id: id });
      ...
      <React.Fragment>
        ...
        <div key={2}>
          ...
          >
            <Modal.Header>
              <Modal.Title>
                <TTitle {...{ name: "HCPriorityLang.EditForm" }} />
              </Modal.Title>
              <FontAwesomeIcon
                icon={faWindowClose}
                color="gray"
