...
type HCAssetHealthStatusLangProps = stateBase<VwHCAssetHealthStatusLang> &
...
class EditHCAssetHealthStatusLang extends React.PureComponent<HCAssetHealthStatusLangProps> {
  ...
  handleSubmit(event: any) {
    ...
    const senddata = convertToObject(sdata) as VwHCAssetHealthStatusLang;
          ...
          <Row>
            <Col md={12} className="T-container">
              ...
              <Form className="edit-form">
                <InputBox
                  {...{
                    name: "HCAssetHealthStatusLang.EditForm.ID",
                ...
                <InputBox
                  {...{
                    name:
                      "HCAssetHealthStatusLang.EditForm.HCAssetHealthStatusId",
                    type: typeComponent.hidden,
                ...
                <Row>
                  <Col md={6}>
                    <InputBox
                      {...{
                        name: "HCAssetHealthStatusLang.EditForm.Name",
                  ...
                  <Col md={6}>
                    <TAutoComplete
                      {...{
                        ...
                        name:"HCAssetHealthStatusLang.EditForm.LanguageId",
                ...
                <Row>
                  <Col md={6}>
                    <InputBox
                      {...{
                        name: "HCAssetHealthStatusLang.EditForm.Description",
                  ...
                  <Col md={6}>
                    <InputBox
                      {...{
                        name: "HCAssetHealthStatusLang.EditForm.IsActive",
                ...
                <Row>
                  <Col md={6}>
                    <TTitle
                      {...{
                        name: "HCAssetHealthStatusLang.EditForm.Creator",
                        size: 6,
                  ...
                  <Col md={6}>
                    <TTitle
                      {...{
                        name: "HCAssetHealthStatusLang.EditForm.updator",
                        size: 6,
                ...
                <Row className="mt-2">
                  <Col md={1}>
                    {this.props.saveLoading === true ? (
                      <TButton
                        {...{
                          name: "HCAssetHealthStatusLang.EditForm.BTN_Save",
                  ...
                  <Col md={1}>
                    <TButton
                      {...{
                        name: "HCAssetHealthStatusLang.EditForm.BTN_Back",
...
)(EditHCAssetHealthStatusLang as any);
