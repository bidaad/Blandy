...
import { VwHCAssetQuality, columnStructure } from '../../../model/viewModel/VwHCAssetQuality';
 
//var CSSTransitionGroup = require('react-transition-group/CSSTransition')


type HCAssetQualityProps =
    stateBase<VwHCAssetQuality> &
...
class HCAssetQuality extends React.PureComponent<HCAssetQualityProps> {
    ...
    componentDidMount() {
        ...
        const rm:AdminModelRequest={pageNo:pageNo,pageSize:pageSize,filter:filter,resourceName:"HCAssetQuality.Menu",isSelected:isSelected,sort:sort,sortKey:sortKey,parentId:this.props.pId,filtersl:this.props.valuefiltersl,noselectId:this.props.noselectId};
    ...
    editRecord = (id: string) => {
        this.props.ChangeTab('','HCAssetQuality','EditHCAssetQuality');
