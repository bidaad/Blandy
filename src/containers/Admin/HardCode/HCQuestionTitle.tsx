...
import { VwHCQuestionTitle, columnStructure } from '../../../model/viewModel/VwHCQuestionTitle';
 

type HCQuestionTitleProps =
    stateBase<VwHCQuestionTitle> &
    typeof HCQuestionTitleStore.actionCreators &
    RouteComponentProps<{}> &
     {  pId: string,selectRecord: any, editable: boolean, isSelected?: boolean, valuefiltersl: string,noselectId:string  };

class HCQuestionTitle extends React.PureComponent<HCQuestionTitleProps> {
    ...
    componentDidMount() {
        ...
        const rm:AdminModelRequest={pageNo:pageNo,pageSize:pageSize,filter:filter,resourceName:"HCQuestionTitle.Menu",isSelected:isSelected,sort:sort,sortKey:sortKey,parentId:this.props.pId,filtersl:this.props.valuefiltersl,noselectId:this.props.noselectId};
    ...
    editRecord = (id: string) => {
        this.props.ChangeTab('','HCQuestionTitle','EditHCQuestionTitle');
