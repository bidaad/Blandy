...
import { VwHCSurveyParameter, columnStructure } from '../../../model/viewModel/VwHCSurveyParameter';
 

type HCSurveyParameterProps =
    stateBase<VwHCSurveyParameter> &
    typeof HCSurveyParameterStore.actionCreators &
    RouteComponentProps<{}> &
     {  pId: string,selectRecord: any, editable: boolean, isSelected?: boolean, valuefiltersl: string,noselectId:string  };

class HCSurveyParameter extends React.PureComponent<HCSurveyParameterProps> {
    ...
    componentDidMount() {
        ...
        const rm:AdminModelRequest={pageNo:pageNo,pageSize:pageSize,filter:filter,resourceName:"HCSurveyParameter.Menu",isSelected:isSelected,sort:sort,sortKey:sortKey,parentId:this.props.pId,filtersl:this.props.valuefiltersl,noselectId:this.props.noselectId};
    ...
    editRecord = (id: string) => {
        this.props.ChangeTab('','HCSurveyParameter','EditHCSurveyParameter');
