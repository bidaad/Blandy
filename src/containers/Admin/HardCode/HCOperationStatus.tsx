...
import { VwHCOperationStatus, columnStructure } from '../../../model/viewModel/VwHCOperationStatus';
 

type HCOperationStatusProps =
    stateBase<VwHCOperationStatus> &
    typeof HCOperationStatusStore.actionCreators &
    RouteComponentProps<{}> &
     {  pId: string,selectRecord: any, editable: boolean, isSelected?: boolean, valuefiltersl: string,noselectId:string  };

class HCOperationStatus extends React.PureComponent<HCOperationStatusProps> {
    ...
    componentDidMount() {
        ...
        const rm:AdminModelRequest={pageNo:pageNo,pageSize:pageSize,filter:filter,resourceName:"HCOperationStatus.Menu",isSelected:isSelected,sort:sort,sortKey:sortKey,parentId:this.props.pId,filtersl:this.props.valuefiltersl,noselectId:this.props.noselectId};
    ...
    editRecord = (id: string) => {
        this.props.ChangeTab('','HCOperationStatus','HCOperationStatusEdit');
