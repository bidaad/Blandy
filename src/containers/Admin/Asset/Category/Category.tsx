...
import * as CategorySLStore from '../../../../store/CategorySL';
import { VwCategory, columnStructure } from '../../../../model/viewModel/VwCategory';
import { AdminModelRequest } from '../../../../model/viewModel/AdminModelRequest';

type CategoryProps =
    stateBase<VwCategory> &
...
class Category extends React.PureComponent<CategoryProps> {
    ...
    componentDidMount() {
        ...
        const rm:AdminModelRequest={pageNo:pageNo,pageSize:pageSize,filter:filter,resourceName:"Category.Menu",isSelected:isSelected,sort:sort,sortKey:sortKey,parentId:this.props.pId,filtersl:this.props.valuefiltersl,noselectId:this.props.noselectId};
    ...
    editRecord = (id: string) => {
        this.props.ChangeTab('','Category','CategoryEdit');
...
class CategorySLClass extends Category {
}

export const CategorySelect = connect(
    (state: ApplicationState) => state.categoriessl,
    CategorySLStore.actionCreators
)(CategorySLClass as any);
