...
import {
  VwAssetPhotographyReq,
  columnStructure,
} from "../../../../model/viewModel/VwAssetPhotographyReq";
import { Modal } from "react-bootstrap";
import AssetPhotographyReqEdit from "./AssetPhotographyReqEdit";
...
type AssetPhotographyReqProps = stateBase<VwAssetPhotographyReq> &
  typeof AssetPhotographyReqStore.actionCreators &
  RouteComponentProps<{}> & {
    pId: string;
    selectRecord: any;
    editable: boolean;
...
class AssetPhotographyReq extends React.PureComponent<
  AssetPhotographyReqProps,
  { showModal: boolean }
> {
  ...
  getData = (
    ...
    const rm: AdminModelRequest = {
      ...
      pageSize: pageSize,
      filter: filter,
      resourceName: "AssetPhotographyReq.Menu",
  ...
  editRecord = (id: string) => {
    ...
    //history.push('/AssetPhotographyReqEdit', { id: id });
    ...
    return (
      <React.Fragment>
        <div key={1}>
          <ReactGrid
            {...{
              title: "AssetPhotographyReq.Grid",
