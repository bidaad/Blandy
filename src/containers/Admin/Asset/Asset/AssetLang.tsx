...
import { VwAssetLang, columnStructure } from '../../../../model/viewModel/VwAssetLang';
import { Modal } from 'react-bootstrap';
import AssetLangEdit from './AssetLangEdit';
...
type AssetLangProps =
    stateBase<VwAssetLang> &
    typeof AssetLangStore.actionCreators &
    RouteComponentProps<{}> &
...
class AssetLang extends React.PureComponent<AssetLangProps, { showModal: boolean }> {
    ...
    componentWillReceiveProps() {
        ...
        const rm:AdminModelRequest={pageNo:pageNo,pageSize:pageSize,filter:filter,resourceName:"AssetLang.Menu",isSelected:isSelected,sort:sort,sortKey:sortKey,parentId:this.props.pId,filtersl:this.props.valuefiltersl,noselectId:this.props.noselectId};
    ...
    editRecord = (id: string) => {
        ...
        //history.push('/AssetLangEdit', { id: id });
            ...
            <React.Fragment>
                ...
                <div key={2}>
                    <Modal size="lg" show={this.state.showModal} onHide={this.handleClose} className={Rtl}>
                        ...
                        <Modal.Body>
                            <AssetLangEdit {...{ closeModal: this.handleClose, refreshGrid: this.refreshGrid, parentId: this.props.pId }} />
                        </Modal.Body>
