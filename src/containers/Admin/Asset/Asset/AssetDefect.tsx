...
import { VwAssetDefect, columnStructure } from '../../../../model/viewModel/VwAssetDefect';
import { Modal } from 'react-bootstrap';
import AssetDefectEdit from './AssetDefectEdit';
...
type AssetDefectProps =
    stateBase<VwAssetDefect> &
    typeof AssetDefectStore.actionCreators &
    RouteComponentProps<{}> &
    { pId: string, isSelected?: boolean, valuefiltersl: string, noselectId: string, selectRecord: any };


class AssetDefect extends React.PureComponent<AssetDefectProps, { showModal: boolean }> {
    ...
    componentWillReceiveProps() {
        ...
        const rm:AdminModelRequest={pageNo:pageNo,pageSize:pageSize,filter:filter,resourceName:"AssetDefect.Grid",isSelected:isSelected,sort:sort,sortKey:sortKey,parentId:this.props.pId,filtersl:this.props.valuefiltersl,noselectId:this.props.noselectId};
    ...
    editRecord = (id: string) => {
        //	
        //history.push('/AssetDefecEdit', { id: id });
            ...
            <React.Fragment>
                ...
                <div key={2}>
                    <Modal size="lg" show={this.state.showModal} onHide={this.handleClose} className={Rtl}>
                        <Modal.Header >
                            <Modal.Title>
                                <TTitle {...{ name: "AssetDefect.EditForm" }} />
                            </Modal.Title>
                            <FontAwesomeIcon icon={faWindowClose} color="gray" size="lg" onClick={this.handleClose} />
                        </Modal.Header>
                        <Modal.Body>
                            <AssetDefectEdit {...{ closeModal: this.handleClose, refreshGrid: this.refreshGrid, parentId: this.props.parentId }} />
                        </Modal.Body>
