...
import { VwAssetUsage, columnStructure } from '../../../../model/viewModel/VwAssetUsage';
...
import AssetUsageEdit from './AssetUsageEdit';


type AssetUsageProps =
    stateBase<VwAssetUsage> &
    typeof AssetUsageStore.actionCreators &
    RouteComponentProps<{}> &
    { pId: string, isSelected?: boolean, valuefiltersl: string, noselectId: string, selectRecord: any };


class AssetUsage extends React.PureComponent<AssetUsageProps, { showModal: boolean }> {
    ...
    componentWillReceiveProps() {
        ...
        const rm:AdminModelRequest={pageNo:pageNo,pageSize:pageSize,filter:filter,resourceName:"AssetUsage.Grid",isSelected:isSelected,sort:sort,sortKey:sortKey,parentId:this.props.pId,filtersl:this.props.valuefiltersl,noselectId:this.props.noselectId};
            ...
            <React.Fragment>
                ...
                <div key={2}>
                    <Modal size="lg" show={this.state.showModal} onHide={this.handleClose} className={Rtl}>
                        <Modal.Header >
                            <Modal.Title>
                                <TTitle {...{ name: "AssetUsage.EditForm" }} />
                            </Modal.Title>
                            <FontAwesomeIcon icon={faWindowClose} color="gray" size="lg" onClick={this.handleClose} />
                        </Modal.Header>
                        <Modal.Body>
                            <AssetUsageEdit {...{ closeModal: this.handleClose, refreshGrid: this.refreshGrid, parentId: this.props.parentId }} />
                        </Modal.Body>
