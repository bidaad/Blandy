...
import { VwAssetAttribute, columnStructure } from '../../../../model/viewModel/VwAssetAttribute';
import {  Modal } from 'react-bootstrap';
import AssetAttributeEdit from './AssetAttributeEdit';
...
type AssetAttributeProps =
    stateBase<VwAssetAttribute> &
    typeof AssetAttributeStore.actionCreators &
    RouteComponentProps<{}> &
...
class AssetAttribute extends React.PureComponent<AssetAttributeProps, { showModal: boolean }> {
    ...
    componentWillReceiveProps() {
        ...
        const rm:AdminModelRequest={pageNo:pageNo,pageSize:pageSize,filter:filter,resourceName:"AssetAttribute.Menu",isSelected:isSelected,sort:sort,sortKey:sortKey,parentId:this.props.pId,filtersl:this.props.valuefiltersl,noselectId:this.props.noselectId};
	...
	//history.push('/AssetAttributeEdit', { id: id });
            ...
            <React.Fragment>
                ...
                <div key={2}>
                    <Modal size="lg" show={this.state.showModal} onHide={this.handleClose} className={Rtl}>
                        ...
                        <Modal.Body>
                            <AssetAttributeEdit {...{ closeModal: this.handleClose, refreshGrid: this.refreshGrid, parentId: this.props.parentId }} />
                        </Modal.Body>
