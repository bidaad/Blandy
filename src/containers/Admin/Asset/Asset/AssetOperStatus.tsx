...
import { VwAssetOperStatus, columnStructure } from '../../../../model/viewModel/VwAssetOperStatus';
import { Modal } from 'react-bootstrap';
import AssetOperStatusEdit from './AssetOperStatusEdit';
...
type AssetOperStatusProps =
    stateBase<VwAssetOperStatus> &
    typeof AssetOperStatusStore.actionCreators &
    RouteComponentProps<{}> &
{  pId: string,selectRecord: any, editable: boolean, isSelected?: boolean, valuefiltersl: string,noselectId:string,typeForm:string  };


class AssetOperStatus extends React.PureComponent<AssetOperStatusProps, { showModal: boolean }> {
    ...
    componentWillReceiveProps() {
        ...
        const rm:AdminModelRequest={pageNo:pageNo,pageSize:pageSize,filter:filter,resourceName:"AssetOperStatus.Menu",isSelected:isSelected,sort:sort,sortKey:sortKey,parentId:this.props.pId,filtersl:this.props.valuefiltersl,noselectId:this.props.noselectId};
    ...
    editRecord = (id: string) => {
        ...
        //history.push('/AssetOperStatusEdit', { id: id });
            ...
            <React.Fragment>
                ...
                <div key={2}>
                    <Modal size="lg" show={this.state.showModal} onHide={this.handleClose} className={Rtl}>
                        ...
                        <Modal.Body>
                            <AssetOperStatusEdit {...{ closeModal: this.handleClose, refreshGrid: this.refreshGrid, parentId: this.props.parentId }} />
                        </Modal.Body>
