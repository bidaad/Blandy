...
import { VwAssignmentDetail, columnStructure } from '../../../../model/viewModel/VwAssignmentDetail';
import { Modal } from 'react-bootstrap';
import AssignmentDetailEdit from './AssignmentDetailEdit';
...
type AssignmentDetailProps =
    stateBase<VwAssignmentDetail> &
    typeof AssignmentDetailStore.actionCreators &
    RouteComponentProps<{}> &
...
class AssignmentDetail extends React.PureComponent<AssignmentDetailProps, { showModal: boolean }> {
    ...
    componentWillReceiveProps() {
        ...
        const rm:AdminModelRequest={pageNo:pageNo,pageSize:pageSize,filter:filter,resourceName:"AssignmentDetail.Menu",isSelected:isSelected,sort:sort,sortKey:sortKey,parentId:this.props.pId,filtersl:this.props.valuefiltersl,noselectId:this.props.noselectId};
    ...
    editRecord = (id: string) => {
        ...
        //history.push('/AssignmentDetailEdit', { id: id });
            ...
            <React.Fragment>
                ...
                <div key={2}>
                    <Modal size="lg" show={this.state.showModal} onHide={this.handleClose} className={Rtl}>
                        ...
                        <Modal.Body>
                            <AssignmentDetailEdit {...{ closeModal: this.handleClose, refreshGrid: this.refreshGrid,parentId: this.props.pId  }} />
                        </Modal.Body>
