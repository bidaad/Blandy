...
import {
  VwProductColor,
  columnStructure,
} from "../../../../model/viewModel/VwProductColor";
...
type ProductColorProps = stateBase<VwProductColor> &
  typeof ProductColorStore.actionCreators &
  RouteComponentProps<{}> & {
    pId: string;
    selectRecord: any;
    editable: boolean;
...
class ProductColor extends React.PureComponent<
  ProductColorProps,
  { showModal: boolean }
  > {
  ...
  getData = (
    ...
    const rm: AdminModelRequest = {
      ...
      pageSize: pageSize,
      filter: filter,
      resourceName: "ProductColor.Menu",
  ...
  editRecord = (id: string) => {
    ...
    //history.push('/ProductColorEdit', { id: id });
