...
import { VwProductAttribute, columnStructure } from '../../../../model/viewModel/VwProductAttribute';
...
class ProductAttribute extends React.PureComponent<ProductAttributeProps, { showModal: boolean }> {
    ...
    componentDidMount() {
        ...
        const rm:AdminModelRequest={pageNo:pageNo,pageSize:pageSize,filter:filter,resourceName:"ProductAttribute.Grid",isSelected:isSelected,sort:sort,sortKey:sortKey,parentId:this.props.pId,filtersl:this.props.valuefiltersl,noselectId:this.props.noselectId};
            ...
            <React.Fragment>
                    ...
                    <div key={2}>
                        <Modal size="lg" show={this.state.showModal} onHide={this.handleClose} className={Rtl}>
                            <Modal.Header >
                                <Modal.Title>
                                    <TTitle {...{name:"ProductAttribute.EditForm"}}/>
                                    </Modal.Title>
                                <FontAwesomeIcon icon={faWindowClose} color="gray" size="lg" onClick={this.handleClose} />
                            </Modal.Header>
                            <Modal.Body>
                                <ProductAttributeEdit {...{ closeModal: this.handleClose, refreshGrid: this.refreshGrid, parentId: this.props.parentId }} />
                            </Modal.Body>
                            {/* <Modal.Footer>
                                </Modal.Footer> */}
                        </Modal>
