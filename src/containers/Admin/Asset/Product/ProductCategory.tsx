...
import { VwProductCategory, columnStructure } from '../../../../model/viewModel/VwProductCategory';
...
class ProductCategory extends React.PureComponent<ProductCategoryProps, { showModal: boolean}> {
    ...
    componentDidMount() {
        ...
        const rm:AdminModelRequest={pageNo:pageNo,pageSize:pageSize,filter:filter,resourceName:"ProductCategory.Grid",isSelected:isSelected,sort:sort,sortKey:sortKey,parentId:this.props.pId,filtersl:this.props.valuefiltersl,noselectId:this.props.noselectId};
            ...
            <React.Fragment>
                    ...
                    <div key={2}>
                        <Modal size="lg"  show={this.state.showModal} onHide={this.handleClose} className={Rtl}>
                            <Modal.Header >
                                <Modal.Title>
                                <TTitle {...{name:"ProductCategory.EditForm"}}/>
                                </Modal.Title>
                                <FontAwesomeIcon icon={faWindowClose} color="gray" size="lg" onClick={this.handleClose} />
                            </Modal.Header>
                            <Modal.Body>
                                <ProductCategoryEdit {...{ closeModal: this.handleClose, refreshGrid: this.refreshGrid, parentId:this.props.parentId }} />
                            </Modal.Body>
                            {/* <Modal.Footer>
