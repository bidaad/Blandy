...
import { VwDepPolicy, columnStructure } from '../../../../model/viewModel/VwDepPolicy';
import { Modal } from 'react-bootstrap';
import DepPolicyEdit from './DepPolicyEdit';
...
type DepPolicyProps =
    stateBase<VwDepPolicy> &
    typeof DepPolicyStore.actionCreators &
    RouteComponentProps<{}> &
{  pId: string,selectRecord: any, editable: boolean, isSelected?: boolean, valuefiltersl: string,noselectId:string,typeForm:string  };


class DepPolicy extends React.PureComponent<DepPolicyProps, { showModal: boolean }> {
    ...
    componentWillReceiveProps() {
        ...
        const rm:AdminModelRequest={pageNo:pageNo,pageSize:pageSize,filter:filter,resourceName:"DepPolicy.Menu",isSelected:isSelected,sort:sort,sortKey:sortKey,parentId:this.props.pId,filtersl:this.props.valuefiltersl,noselectId:this.props.noselectId};
    ...
    editRecord = (id: string) => {
        ...
        //history.push('/DepPolicyEdit', { id: id });
            ...
            <React.Fragment>
                ...
                <div key={2}>
                    <Modal size="lg" show={this.state.showModal} onHide={this.handleClose} className={Rtl}>
                        ...
                        <Modal.Body>
                            <DepPolicyEdit {...{ closeModal: this.handleClose, refreshGrid: this.refreshGrid, parentId: this.props.parentId }} />
                        </Modal.Body>
