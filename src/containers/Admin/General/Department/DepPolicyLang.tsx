...
import { VwDepPolicyLang, columnStructure } from '../../../../model/viewModel/VwDepPolicyLang';
import { Modal } from 'react-bootstrap';
import DepPolicyLangEdit from './DepPolicyLangEdit';
...
type DepPolicyLangProps =
    stateBase<VwDepPolicyLang> &
    typeof DepPolicyLangStore.actionCreators &
    RouteComponentProps<{}> &
    {  pId: string,selectRecord: any, editable: boolean, isSelected?: boolean, valuefiltersl: string,noselectId:string,typeForm:string  };


class DepPolicyLang extends React.PureComponent<DepPolicyLangProps, { showModal: boolean }> {
    ...
    componentWillReceiveProps() {
        ...
        const rm:AdminModelRequest={pageNo:pageNo,pageSize:pageSize,filter:filter,resourceName:"DepPolicyLang.Menu",isSelected:isSelected,sort:sort,sortKey:sortKey,parentId:this.props.pId,filtersl:this.props.valuefiltersl,noselectId:this.props.noselectId};
	...
	//history.push('/DepPolicyLangEdit', { id: id });
...
sort: this.props.sort,
                ...
                <div key={2}>
                    <Modal size="lg" show={this.state.showModal} onHide={this.handleClose} className={Rtl}>
                        ...
                        <Modal.Body>
                            <DepPolicyLangEdit {...{ closeModal: this.handleClose, refreshGrid: this.refreshGrid, parentId: this.props.parentId }} />
                        </Modal.Body>
