...
import {
  VwDepSkill,
  columnStructure,
} from "../../../../model/viewModel/VwDepSkill";
import { Modal } from "react-bootstrap";
import DepSkillEdit from "./DepSkillEdit";
...
class DepSkill extends React.PureComponent<
  DepSkillProps,
  { showModal: boolean }
> {
  ...
  editRecord = (id: string) => {
    ...
    //history.push('/DepSkillEdit', { id: id });
