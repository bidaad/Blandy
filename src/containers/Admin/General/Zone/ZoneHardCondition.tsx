...
import {
  VwZoneHardCondition,
  columnStructure,
} from "../../../../model/viewModel/VwZoneHardCondition";
import { Modal } from "react-bootstrap";
import ZoneHardConditionEdit from "./ZoneHardConditionEdit";
...
class ZoneHardCondition extends React.PureComponent<
  ZoneHardConditionProps,
  { showModal: boolean }
> {
  ...
  getData = (
    ...
    const rm: AdminModelRequest = {
      ...
      pageSize: pageSize,
      filter: filter,
      resourceName: "ZoneHardCondition.Menu",
  ...
  editRecord = (id: string) => {
    ...
    //history.push('/ZoneHardConditionEdit', { id: id });
      ...
      <React.Fragment>
        ...
        <div key={2}>
          ...
          >
            <Modal.Header>
              <Modal.Title>
                <TTitle {...{ name: "ZoneHardCondition.EditForm" }} />
              </Modal.Title>
              <FontAwesomeIcon
                icon={faWindowClose}
                color="gray"
