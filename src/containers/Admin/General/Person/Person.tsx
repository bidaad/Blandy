...
import * as PersonSLStore from '../../../../store/PersonSL';
import { VwPerson, columnStructure } from '../../../../model/viewModel/VwPerson';
...
class Person extends React.PureComponent<BrandProps> {
    ...
    componentDidMount() {
        ...
        const rm:AdminModelRequest={pageNo:pageNo,pageSize:pageSize,filter:filter,resourceName:"Person.Menu",isSelected:isSelected,sort:sort,sortKey:sortKey,parentId:this.props.pId,filtersl:this.props.valuefiltersl,noselectId:this.props.noselectId};
    ...
    editRecord = (id: string) => {
        this.props.ChangeTab('','person','personEdit');
...
class PersonSLClass extends Person {
}

export const PersonSelect = connect(
    (state: ApplicationState) => state.personssl,
    PersonSLStore.actionCreators
)(PersonSLClass as any);
