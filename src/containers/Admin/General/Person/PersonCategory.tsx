...
import {
  VwPersonCategory,
  columnStructure,
} from "../../../../model/viewModel/VwPersonCategory";
import { Modal } from "react-bootstrap";
import PersonCategoryEdit from "./PersonCategoryEdit";
...
type PersonCategoryProps = stateBase<VwPersonCategory> &
  typeof PersonCategoryStore.actionCreators &
  RouteComponentProps<{}> & {
    pId: string;
    selectRecord: any;
    editable: boolean;
...
class PersonCategory extends React.PureComponent<
  PersonCategoryProps,
  { showModal: boolean }
> {
  ...
  getData = (
    ...
    const rm: AdminModelRequest = {
      ...
      pageSize: pageSize,
      filter: filter,
      resourceName: "PersonCategory.Menu",
  ...
  editRecord = (id: string) => {
    ...
    //history.push('/PersonCategoryEdit', { id: id });
