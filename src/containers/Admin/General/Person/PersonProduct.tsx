...
import {
  VwPersonProduct,
  columnStructure,
} from "../../../../model/viewModel/VwPersonProduct";
import { Modal } from "react-bootstrap";
import PersonProductEdit from "./PersonProductEdit";
...
type PersonProductProps = stateBase<VwPersonProduct> &
  typeof PersonProductStore.actionCreators &
  RouteComponentProps<{}> & {
    pId: string;
    selectRecord: any;
    editable: boolean;
...
class PersonProduct extends React.PureComponent<
  PersonProductProps,
  { showModal: boolean }
> {
  ...
  getData = (
    ...
    const rm: AdminModelRequest = {
      ...
      pageSize: pageSize,
      filter: filter,
      resourceName: "PersonProduct.Menu",
  ...
  editRecord = (id: string) => {
    ...
    //history.push('/PersonProductEdit', { id: id });
