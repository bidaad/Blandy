...
import * as PersonBrandStore from '../../../../store/PersonBrand';
import { VwPersonBrand, columnStructure } from '../../../../model/viewModel/VwPersonBrand';
...
type PersonBrandProps =
    stateBase<VwPersonBrand> &
    typeof PersonBrandStore.actionCreators &
    RouteComponentProps<{}> &
    {  pId: string,selectRecord: any, editable: boolean, isSelected?: boolean, valuefiltersl: string,noselectId:string,typeForm:string  };



class PersonBrand extends React.PureComponent<PersonBrandProps, { showModal: boolean }> {
    ...
    componentWillReceiveProps() {
        ...
        const rm:AdminModelRequest={pageNo:pageNo,pageSize:pageSize,filter:filter,resourceName:"PersonLang.Menu",isSelected:isSelected,sort:sort,sortKey:sortKey,parentId:this.props.pId,filtersl:this.props.valuefiltersl,noselectId:this.props.noselectId};
	...
	//history.push('/PersonBrandEdit', { id: id });
            ...
            <React.Fragment>
                ...
                <div key={2}>
                    <Modal size="lg" show={this.state.showModal} onHide={this.handleClose} className={Rtl}>
                        <Modal.Header >
                            <Modal.Title>
                                <TTitle {...{ name: "PersonBrand.EditForm" }} />
                            </Modal.Title>
                            <FontAwesomeIcon icon={faWindowClose} color="gray" size="lg" onClick={this.handleClose} />
                        </Modal.Header>
                        <Modal.Body>
                            {/* <PersonBrandEdit {...{ closeModal: this.handleClose, refreshGrid: this.refreshGrid, parentId: this.props.parentId }} /> */}
                        </Modal.Body>
...
export default connect(
    (state: ApplicationState) => state.personbrands,
    PersonBrandStore.actionCreators
)(PersonBrand as any);
