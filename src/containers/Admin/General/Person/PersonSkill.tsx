...
import {
  VwPersonSkill,
  columnStructure,
} from "../../../../model/viewModel/VwPersonSkill";
import { Modal } from "react-bootstrap";
import PersonSkillEdit from "./PersonSkillEdit";
...
type PersonSkillProps = stateBase<VwPersonSkill> &
  typeof PersonSkillStore.actionCreators &
  RouteComponentProps<{}> & {
    pId: string;
    selectRecord: any;
    editable: boolean;
...
class PersonSkill extends React.PureComponent<
  PersonSkillProps,
  { showModal: boolean }
> {
  ...
  editRecord = (id: string) => {
    ...
    //history.push('/PersonSkillEdit', { id: id });
