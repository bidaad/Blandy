...
import { VwMessageLang, columnStructure } from '../../../../model/viewModel/VwMessageLang';
import MessageLangEdit from './MessageLangEdit';
...
class MessageLang extends React.PureComponent<MessageLangProps, { showModal: boolean }> {
    ...
    componentWillReceiveProps() {
        ...
        const rm:AdminModelRequest={pageNo:pageNo,pageSize:pageSize,filter:filter,resourceName:"MessageLang.Menu",isSelected:isSelected,sort:sort,sortKey:sortKey,parentId:this.props.pId,filtersl:this.props.valuefiltersl,noselectId:this.props.noselectId};
            ...
            <React.Fragment>
                ...
                <div key={2}>
                    <Modal size="lg" show={this.state.showModal} onHide={this.handleClose} className={Rtl}>
                        <Modal.Header >
                            <Modal.Title>
                                <TTitle {...{ name: "MessageLang.EditForm" }} />
                            </Modal.Title>
                            <FontAwesomeIcon icon={faWindowClose} color="gray" size="lg" onClick={this.handleClose} />
                        </Modal.Header>
                        <Modal.Body>
                            <MessageLangEdit {...{ closeModal: this.handleClose, refreshGrid: this.refreshGrid, parentId: this.props.parentId }} />
                        </Modal.Body>
                    </Modal>
                </div>
            </React.Fragment>
