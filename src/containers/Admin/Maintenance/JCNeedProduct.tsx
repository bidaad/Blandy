...
import { VwJCNeedProduct, columnStructure } from '../../../model/viewModel/VwJCNeedProduct';
import { Modal } from 'react-bootstrap';
import JCNeedProductEdit from './JCNeedProductEdit';
...
type JCNeedProductProps =
    stateBase<VwJCNeedProduct> &
    typeof JCNeedProductStore.actionCreators &
    RouteComponentProps<{}> &
    {  pId: string,selectRecord: any, editable: boolean, isSelected?: boolean, valuefiltersl: string,noselectId:string,typeForm:string  };


class JCNeedProduct extends React.PureComponent<JCNeedProductProps, { showModal: boolean }> {
    ...
    componentWillReceiveProps() {
        ...
        const rm:AdminModelRequest={pageNo:pageNo,pageSize:pageSize,filter:filter,resourceName:"JCNeedProduct.Menu",isSelected:isSelected,sort:sort,sortKey:sortKey,parentId:this.props.pId,filtersl:this.props.valuefiltersl,noselectId:this.props.noselectId};
	...
	//	
	//history.push('/JCNeedProducEdit', { id: id });
            ...
            <React.Fragment>
                ...
                <div key={2}>
                    <Modal size="lg" show={this.state.showModal} onHide={this.handleClose} className={Rtl}>
                        ...
                        <Modal.Body>
                            <JCNeedProductEdit {...{ closeModal: this.handleClose, refreshGrid: this.refreshGrid, parentId: this.props.pId }} />
                        </Modal.Body>
