...
import { VwJobCardLang, columnStructure } from '../../../model/viewModel/VwJobCardLang';
import { Modal } from 'react-bootstrap';
import JobCardLangEdit from './JobCardLangEdit';
...
type JobCardLangProps =
    stateBase<VwJobCardLang> &
    typeof JobCardLangStore.actionCreators &
    RouteComponentProps<{}> &
    {  pId: string,selectRecord: any, editable: boolean, isSelected?: boolean, valuefiltersl: string,noselectId:string,typeForm:string  };


class JobCardLang extends React.PureComponent<JobCardLangProps, { showModal: boolean }> {
    ...
    componentWillReceiveProps() {
        ...
        const rm:AdminModelRequest={pageNo:pageNo,pageSize:pageSize,filter:filter,resourceName:"JobCardLang.Menu",isSelected:isSelected,sort:sort,sortKey:sortKey,parentId:this.props.pId,filtersl:this.props.valuefiltersl,noselectId:this.props.noselectId};
	...
	//history.push('/JobCardLangEdit', { id: id });
            ...
            <React.Fragment>
                ...
                <div key={2}>
                    <Modal size="lg" show={this.state.showModal} onHide={this.handleClose} className={Rtl}>
                        ...
                        <Modal.Body>
                            <JobCardLangEdit {...{ closeModal: this.handleClose, refreshGrid: this.refreshGrid, parentId: this.props.pId }} />
                        </Modal.Body>
