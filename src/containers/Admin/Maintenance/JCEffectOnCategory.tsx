...
import { VwJCEffectOnCategory, columnStructure } from '../../../model/viewModel/VwJCEffectOnCategory';
import { Modal } from 'react-bootstrap';
import JCEffectOnCategoryEdit from './JCEffectOnCategoryEdit';
...
type JCEffectOnCategoryProps =
    stateBase<VwJCEffectOnCategory> &
    typeof JCEffectOnCategoryStore.actionCreators &
    RouteComponentProps<{}> &
    { pId: string, selectRecord: any, editable: boolean, isSelected?: boolean, valuefiltersl: string, noselectId: string, typeForm: string };


class JCEffectOnCategory extends React.PureComponent<JCEffectOnCategoryProps, { showModal: boolean }> {
    ...
    getData = (pageNo: number, pageSize: number, filter: string, sort?: string, sortKey?: string) => {
        ...
        const rm: AdminModelRequest = { pageNo: pageNo, pageSize: pageSize, filter: filter, resourceName: "JCEffectOnCategory.Menu", isSelected: isSelected, sort: sort, sortKey: sortKey, parentId: this.props.pId, filtersl: this.props.valuefiltersl, noselectId: this.props.noselectId };
    ...
    editRecord = (id: string) => {
        ...
        //history.push('/JCEffectOnCategoryEdit', { id: id });
            ...
            <React.Fragment>
                ...
                <div key={2}>
                    <Modal size="lg" show={this.state.showModal} onHide={this.handleClose} className={Rtl}>
                        ...
                        <Modal.Body>
                            <JCEffectOnCategoryEdit {...{ closeModal: this.handleClose, refreshGrid: this.refreshGrid, parentId: this.props.pId }} />
                        </Modal.Body>
