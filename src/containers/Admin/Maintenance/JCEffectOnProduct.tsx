...
import { VwJCEffectOnProduct, columnStructure } from '../../../model/viewModel/VwJCEffectOnProduct';
import { Modal } from 'react-bootstrap';
import JCEffectOnProductEdit from './JCEffectOnProductEdit';
...
type JCEffectOnProductProps =
    stateBase<VwJCEffectOnProduct> &
    typeof JCEffectOnProductStore.actionCreators &
    RouteComponentProps<{}> &
    {  pId: string,selectRecord: any, editable: boolean, isSelected?: boolean, valuefiltersl: string,noselectId:string,typeForm:string  };


class JCEffectOnProduct extends React.PureComponent<JCEffectOnProductProps, { showModal: boolean }> {
    ...
    componentWillReceiveProps() {
        ...
        const rm:AdminModelRequest={pageNo:pageNo,pageSize:pageSize,filter:filter,resourceName:"JCEffectOnProduct.Menu",isSelected:isSelected,sort:sort,sortKey:sortKey,parentId:this.props.pId,filtersl:this.props.valuefiltersl,noselectId:this.props.noselectId};
	...
	//	
	//history.push('/JCEffectOnProducEdit', { id: id });
...
sort: this.props.sort,
                ...
                <div key={2}>
                    <Modal size="lg" show={this.state.showModal} onHide={this.handleClose} className={Rtl}>
                        ...
                        <Modal.Body>
                            <JCEffectOnProductEdit {...{ closeModal: this.handleClose, refreshGrid: this.refreshGrid, parentId: this.props.pId }} />
                        </Modal.Body>
