...
import { VwJCNeedCategory, columnStructure } from '../../../model/viewModel/VwJCNeedCategory';
import { Modal } from 'react-bootstrap';
import JCNeedCategoryEdit from './JCNeedCategoryEdit';
...
type JCNeedCategoryProps =
    stateBase<VwJCNeedCategory> &
    typeof JCNeedCategoryStore.actionCreators &
    RouteComponentProps<{}> &
    {  pId: string,selectRecord: any, editable: boolean, isSelected?: boolean, valuefiltersl: string,noselectId:string,typeForm:string  };


class JCNeedCategory extends React.PureComponent<JCNeedCategoryProps, { showModal: boolean }> {
    ...
    componentWillReceiveProps() {
        ...
        const rm:AdminModelRequest={pageNo:pageNo,pageSize:pageSize,filter:filter,resourceName:"JCNeedCategory.Menu",isSelected:isSelected,sort:sort,sortKey:sortKey,parentId:this.props.pId,filtersl:this.props.valuefiltersl,noselectId:this.props.noselectId};
	...
	//history.push('/JCNeedCategoryEdit', { id: id });
...
sort: this.props.sort,
                ...
                <div key={2}>
                    <Modal size="lg" show={this.state.showModal} onHide={this.handleClose} className={Rtl}>
                        ...
                        <Modal.Body>
                            <JCNeedCategoryEdit {...{ closeModal: this.handleClose, refreshGrid: this.refreshGrid, parentId: this.props.pId }} />
                        </Modal.Body>
