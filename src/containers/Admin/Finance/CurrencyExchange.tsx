...
import { VwCurrencyExchange, columnStructure } from '../../../model/viewModel/VwCurrencyExchange';
import { AdminModelRequest } from '../../../model/viewModel/AdminModelRequest';

type CurrencyExchangeProps =
    stateBase<VwCurrencyExchange> &
...
class CurrencyExchange extends React.PureComponent<CurrencyExchangeProps> {
    ...
    componentDidMount() {
        ...
        const rm:AdminModelRequest={pageNo:pageNo,pageSize:pageSize,filter:filter,resourceName:"CurrencyExchange.Menu",isSelected:isSelected,sort:sort,sortKey:sortKey,parentId:this.props.pId,filtersl:this.props.valuefiltersl,noselectId:this.props.noselectId};
    ...
    editRecord = (id: string) => {
        this.props.ChangeTab('','CurrencyExchange','CurrencyExchangeEdit');
