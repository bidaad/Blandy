...
import { VwAccount, columnStructure } from '../../../model/viewModel/VwAccount';
...
class Account extends React.PureComponent<AccountProps> {
    ...
    componentDidMount() {
        ...
        const rm:AdminModelRequest={pageNo:pageNo,pageSize:pageSize,filter:filter,resourceName:"Account.Menu",isSelected:isSelected,sort:sort,sortKey:sortKey,parentId:this.props.pId,filtersl:this.props.valuefiltersl,noselectId:this.props.noselectId};
    ...
    editRecord = (id: string) => {
        ...
        this.props.ChangeTab('','Account','AccountEdit');
