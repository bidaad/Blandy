...
import { VwPayment, columnStructure } from '../../../model/viewModel/VwPayment';
...
class Payment extends React.PureComponent<PaymentProps> {
    ...
    componentDidMount() {
        ...
        const rm:AdminModelRequest={pageNo:pageNo,pageSize:pageSize,filter:filter,resourceName:"Payment.Menu",isSelected:isSelected,sort:sort,sortKey:sortKey,parentId:this.props.pId,filtersl:this.props.valuefiltersl,noselectId:this.props.noselectId};
    ...
    editRecord = (id: string) => {
        this.props.ChangeTab('','Payment','PaymentEdit');
