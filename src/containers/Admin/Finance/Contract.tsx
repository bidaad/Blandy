...
import * as ContractSLStore from "../../../store/ContractSL";
import {
  VwContract,
  columnStructure,
} from "../../../model/viewModel/VwContract";
...
type ContractProps = stateBase<VwContract> &
  typeof ContractStore.actionCreators &
  RouteComponentProps<{}> & {
    pId: string;
    selectRecord: any;
    editable: boolean;
...
> {
  ...
  editRecord = (id: string) => {
    ...
    //history.push('/ContractEdit', { id: id });
...
class ContractSLClass extends Contract {
}

export const ContractSelect = connect(
    (state: ApplicationState) => state.contractsl,
    ContractSLStore.actionCreators
)(ContractSLClass as any);
